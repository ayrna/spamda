...
%		\end{keyword}
	...
	\section{Introduction}
		...
		\begin{itemize}
			...
			\item It makes the researcher focus on environmental modelling, without having to worry about mechanical tasks, avoiding laborious and pre-processing procedures that implies a lot of time and effort.
			\item It manages the extensive casuistry of the data integration which can lead to incomplete datasets.
			\item It avoids possible researcher errors in the intermediate steps of the process of creation of the datasets, such as time and geographical coordinates conversion or missing values handling (dates or measurements not recorded), among others.
